...
//
//        @GetMapping("/{postId}")
//        public ResponseEntity<ApiResult<PostDetailRespDto>> getPostById (@PathVariable(value = "postId") Long
//        postId, @AuthenticationPrincipal LoginUser loginUser){
//            return new ResponseEntity<>(ApiResult.success(postService.getPostById(postId, loginUser)), HttpStatus.OK);
//        }
//
//        @GetMapping("/{postId}/comments")
//        public ResponseEntity<ApiResult<CommentListRespDto>> getCommentsByPostId (@PathVariable(value = "postId") Long
//        postId,
